...
namespace Engine
{
	...
	enum SoundType {
		...
		PLAYER_SHOT_M3_FIRE, 
		PLAYER_MOVE_SOUND1, PLAYER_SHOT_SOUND1, PLAYER_BULLET_EXIT_SOUND1, BOOM1, SOUND_END
	};
	...
	enum BULLET_ID { SMOKE_BULLET, MASHINE_BULLET, CANNONBALL, MASHINE_BULLET_RELOAD, CANNONBALL_RELOAD, BULLET_END };

	enum CAMERA_ID {SIMPLE_CAMERA , DYNAMIC_CAMERA, TANK_CAMERA , TOPVIEW_CAMERA,AIM_CAMERA,CAMERA_END};
