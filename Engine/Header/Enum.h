...
namespace Engine
{
	...
	enum SoundType {
		...
		SELECT_SOUND, PASS_SOUND, DRONE_SOUND, AH_64A_SOUND,
	...
	enum BULLET_ID {
		...
		BOOM_BULLET, SMOKE_BULLET, MASHINE_BULLET_RELOAD, CANNONBALL_RELOAD, SHIP_BULLET, SHIP_REAL_BULLET, BULLET_END };
	...
	enum CAMERA_ID {AH_64A_CAMERA, AH_64A_AIMCAMERA, MOONWALK_CAMERA, BOOM_CAMERA, DRONE_CAMERA, SIMPLE_CAMERA, DYNAMIC_CAMERA, TANK_CAMERA, TOPVIEW_CAMERA, AIM_CAMERA, CAMERA_END };
