#include "..\..\Header\VIBullet_Re.h"


CVIBullet_Re::CVIBullet_Re(LPDIRECT3DDEVICE9 pGraphicDev)
	: CVIBuffer(pGraphicDev)
{
}

CVIBullet_Re::CVIBullet_Re(const CVIBullet_Re & rhs)
	: CVIBuffer(rhs)
{
}

CVIBullet_Re::~CVIBullet_Re()
{
}

HRESULT CVIBullet_Re::Ready_Buffer(void)
{
	m_dwVtxCnt = 9;
...
CVIBullet_Re * CVIBullet_Re::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CVIBullet_Re*		pInstance = new CVIBullet_Re(pGraphicDev);
...
CVIBullet_Re * CVIBullet_Re::Clone(void)
{
	return new CVIBullet_Re(*this);
}

void CVIBullet_Re::Free(void)
{
	__super::Free();
}
