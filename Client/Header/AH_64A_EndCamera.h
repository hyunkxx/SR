...
class CAH_64A_EndCamera :
	public CCamera
{
public:
	explicit CAH_64A_EndCamera(LPDIRECT3DDEVICE9 pGraphicDev);
	explicit CAH_64A_EndCamera(const CAH_64A_EndCamera & rhs);
	virtual ~CAH_64A_EndCamera();
public:
...
public:
	static	CAH_64A_EndCamera*	Create(LPDIRECT3DDEVICE9 pGraphicDev,
		const _vec3* pEye,
		const _vec3* pAt,
		const _vec3* pUp,
