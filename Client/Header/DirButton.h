...
class CDirButton : public Engine::CGameObject
{
public:
	enum class DIR { LEFT, RIGHT };
private:
	explicit CDirButton(LPDIRECT3DDEVICE9 pGraphicDev, DIR eType);
	explicit CDirButton(const CDirButton& rhs);
	virtual ~CDirButton();
public:
	static CDirButton*	Create(LPDIRECT3DDEVICE9 pGraphicDev, DIR eType);
public:
