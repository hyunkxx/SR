...
class CUI_Speed : public Engine::CGameObject
{
private:
	explicit CUI_Speed(LPDIRECT3DDEVICE9 pGraphicDev);
	explicit CUI_Speed(const CUI_Speed& rhs);
	virtual ~CUI_Speed();
...
public:
	...
	static CUI_Speed*		Create(LPDIRECT3DDEVICE9 pGraphicDev);
