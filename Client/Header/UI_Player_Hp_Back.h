...
class CUI_Player_Hp_Back : public Engine::CGameObject
{
private:
	explicit CUI_Player_Hp_Back(LPDIRECT3DDEVICE9 pGraphicDev);
	explicit CUI_Player_Hp_Back(const CUI_Player_Hp_Back& rhs);
	virtual ~CUI_Player_Hp_Back();
...
public:
	...
	static CUI_Player_Hp_Back*		Create(LPDIRECT3DDEVICE9 pGraphicDev);
