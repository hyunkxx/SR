...
class CAICreateButton : public Engine::CGameObject
{
private:
	explicit CAICreateButton(LPDIRECT3DDEVICE9 pGraphicDev, VEHICLE eType);
	explicit CAICreateButton(const CAICreateButton& rhs);
	virtual ~CAICreateButton();
public:
	static CAICreateButton*	Create(LPDIRECT3DDEVICE9 pGraphicDev, VEHICLE eType);
public:
