...
class CModeButton : public Engine::CGameObject
{
public:
	enum class GMODE { WAR, RUSH };
private:
	explicit CModeButton(LPDIRECT3DDEVICE9 pGraphicDev, GMODE eType);
	explicit CModeButton(const CModeButton& rhs);
	virtual ~CModeButton();
public:
	static CModeButton*	Create(LPDIRECT3DDEVICE9 pGraphicDev, GMODE eType);
public:
