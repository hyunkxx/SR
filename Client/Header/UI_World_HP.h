...
class CUI_World_HP : public Engine::CGameObject
{
private:
	explicit CUI_World_HP(LPDIRECT3DDEVICE9 pGraphicDev);
	explicit CUI_World_HP(const CUI_World_HP& rhs);
	virtual ~CUI_World_HP();
...
public:
	...
	static CUI_World_HP*		Create(LPDIRECT3DDEVICE9 pGraphicDev, _float fOrigin_HP);
