...
class CGameButton : public Engine::CGameObject
{
public:
	enum class TYPE { START, EXIT };
private:
	explicit CGameButton(LPDIRECT3DDEVICE9 pGraphicDev, TYPE eType);
	explicit CGameButton(const CGameButton& rhs);
	virtual ~CGameButton();
public:
	static CGameButton*	Create(LPDIRECT3DDEVICE9 pGraphicDev, TYPE eType);
public:
