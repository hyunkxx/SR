...
class CUI_BlueTeam_Kill_Back :	public Engine::CGameObject
{
private:
	explicit CUI_BlueTeam_Kill_Back(LPDIRECT3DDEVICE9 pGraphicDev);
	explicit CUI_BlueTeam_Kill_Back(const CUI_BlueTeam_Kill_Back& rhs);
	virtual ~CUI_BlueTeam_Kill_Back();
...
public:
	...
	static CUI_BlueTeam_Kill_Back*		Create(LPDIRECT3DDEVICE9 pGraphicDev);
