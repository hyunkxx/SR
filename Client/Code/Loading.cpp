...
#pragma endregion
	...
	FAILED_CHECK_RETURN(Engine::Ready_Prototype(L"Proto_UI_Slider_Tex", Engine::CTexture::Create(m_pGraphicDev, L"../Bin/Resource/Texture/Ui/Wheel_Slider.png", TEX_NORMAL)), E_FAIL);
	...
	FAILED_CHECK_RETURN(Engine::Ready_Prototype(L"Proto_Minimap_P_AH_Tex", Engine::CTexture::Create(m_pGraphicDev, L"../Bin/Resource/Texture/Ui/OccupationColor_2.png", TEX_NORMAL)), E_FAIL);
	...
	FAILED_CHECK_RETURN(Engine::Ready_Prototype(L"Proto_Minimap_Boom_Tex", Engine::CTexture::Create(m_pGraphicDev, L"../Bin/Resource/Texture/Ui/Reload_Bar0.png", TEX_NORMAL)), E_FAIL);
	FAILED_CHECK_RETURN(Engine::Ready_Prototype(L"Proto_Minimap_ShipBoom_Tex", Engine::CTexture::Create(m_pGraphicDev, L"../Bin/Resource/Texture/Ui/Reload_Bar0.png", TEX_NORMAL)), E_FAIL);
