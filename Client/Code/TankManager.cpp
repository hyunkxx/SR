...
void CTankManager::InitalizeData()
{
	...
	tankData[(UINT)VEHICLE::HUMVEE].fPosinDist = 2.5f;
	...
	//포신 길이, 포신 최대 각도, 회전속도 설정
	tankData[(UINT)VEHICLE::SMALL_TANK].fPosinDist = 2.5f;
	...
	// 장전 속도
	tankData[(UINT)VEHICLE::SMALL_TANK].fReload = 1.5f;
	tankData[(UINT)VEHICLE::SMALL_TANK].fReloadTime = 1.5f;
	...
	//포신 길이, 포신 최대 각도, 회전속도 설정
	tankData[(UINT)VEHICLE::MIDDLE_TANK].fPosinDist = 2.5f;
	...
	tankData[(UINT)VEHICLE::BIG_TANK].iCannonSpeed = 400;
	...
	tankData[(UINT)VEHICLE::LONG_TANK].iCannonSpeed = 1300;
}
