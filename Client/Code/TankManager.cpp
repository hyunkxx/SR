...
void CTankManager::InitalizeData()
{
	...
	tankData[(UINT)VEHICLE::HUMVEE].fLowAngle = D3DXToRadian(10.f);
	tankData[(UINT)VEHICLE::HUMVEE].TopAngle = D3DXToRadian(-30.f);
	...
	tankData[(UINT)VEHICLE::SMALL_TANK].fLowAngle = D3DXToRadian(10.f);
	tankData[(UINT)VEHICLE::SMALL_TANK].TopAngle = D3DXToRadian(-30.f);
	...
	tankData[(UINT)VEHICLE::MIDDLE_TANK].fLowAngle = D3DXToRadian(10.f);
	tankData[(UINT)VEHICLE::MIDDLE_TANK].TopAngle = D3DXToRadian(-30.f);
	...
	tankData[(UINT)VEHICLE::BIG_TANK].TopAngle = D3DXToRadian(-30.f);
	...
	tankData[(UINT)VEHICLE::LONG_TANK].TopAngle = D3DXToRadian(-30.f);
